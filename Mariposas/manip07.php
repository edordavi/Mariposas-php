<?php
$titulo='Consulta Manipulaci&oacute;n #7';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 007</legend>
    ...
    $consulta = $conexion->prepare("SELECT * FROM vst_colecciones");
    //$consulta->bind_param("s", "1999-04-30");
    $consulta->execute();
    $consulta->bind_result($nombre,$apellido,$dni,$precioEstimado);
    ?>
    ...
    while($consulta->fetch()){
        ...
        echo "<td>".utf8_encode($precioEstimado)."</td>";
