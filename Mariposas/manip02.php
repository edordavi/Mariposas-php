<?php
$titulo='Consulta Manipulaci&oacute;n #2';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 002</legend>
    ...
    $consulta = $conexion->prepare("CALL sp_nombres_comunes_cientificos_intervalo('1996-01-01','1997-12-31')");
    //$consulta->bind_param("s", "1999-04-30");
    $consulta->execute();
    $consulta->bind_result($zona,$nom_comun,$nom_cient);
    ?>
    ...
    while($consulta->fetch()){
        ...
        echo "<tr>";
        echo "<td>".utf8_decode($zona)."</td>";
        echo "<td>".utf8_decode($nom_comun)."</td>";
        echo "<td>".utf8_decode($nom_cient)."</td>";
//        echo <<<HTML
