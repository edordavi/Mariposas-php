<?php
$titulo='Consulta Manipulaci&oacute;n #4';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 004</legend>
    ...
    $consulta = $conexion->prepare("CALL sp_familias_liberadas()");
