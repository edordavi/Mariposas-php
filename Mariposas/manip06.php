<?php
$titulo='Consulta Manipulaci&oacute;n #6';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 006</legend>
    ...
    $consulta = $conexion->prepare("CALL sp_zonas_mas_6capturas()");
    //$consulta->bind_param("s", "1999-04-30");
    $consulta->execute();
    $consulta->bind_result($zona,$pais,$region,$cantidadCapt);
    ?>
    ...
    while($consulta->fetch()){
        ...
        echo "<tr>";
        echo "<td>".utf8_encode($zona)."</td>";
        echo "<td>".utf8_encode($pais)."</td>";
        echo "<td>".utf8_encode($region)."</td>";
        echo "<td>".utf8_encode($cantidadCapt)."</td>";
