<?php
$titulo='Consulta Manipulaci&oacute;n #5';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 005</legend>
    ...
    $consulta = $conexion->prepare("CALL sp_especies_nocapturadas()");
    //$consulta->bind_param("s", "1999-04-30");
    $consulta->execute();
    $consulta->bind_result($familia,$genero,$especie);
    ?>
    ...
    while($consulta->fetch()){
        ...
        echo "<tr>";
        echo "<td>".utf8_encode($familia)."</td>";
