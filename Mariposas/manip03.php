<?php
$titulo='Consulta Manipulaci&oacute;n #3';
...
<fieldset><legend>Consulta Manipulaci&oacute;n de Datos 003</legend>
    ...
    $consulta = $conexion->prepare("CALL sp_ejemplar_precio_mayormenor()");
    //$consulta->bind_param("s", "1999-04-30");
    $consulta->execute();
    $consulta->bind_result($especie,$capturadaPor,$coleccionista,$precio);
    ?>
        <table border=2 width=100% id="datos1">
            <tr>
                <td><b>ESPECIE</b></td>
                <td><b>CAPTURADA POR</b></td>
                <td><b>DNI COLECCIONISTA</b></td>
                <td><b>PRECIO</b></td>
            </tr>
    <?php 
    ...
    while($consulta->fetch()){
        ...
        echo "<td>".utf8_encode($capturadaPor)."</td>";
        echo "<td>".utf8_encode($coleccionista)."</td>";
        echo "<td>".utf8_encode($precio)."</td>";
//        echo <<<HTML
