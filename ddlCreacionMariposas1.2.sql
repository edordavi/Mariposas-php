...
ALTER TABLE Coleccionada ADD CONSTRAINT Coleccionada_PK PRIMARY KEY ( zona, fecha_captura ) ;
...
ALTER TABLE Observada ADD CONSTRAINT Observada_PK PRIMARY KEY ( zona, fecha_captura ) ;
...
ALTER TABLE Coleccionada ADD CONSTRAINT Coleccionada_Ejemplar_FK FOREIGN KEY ( zona, fecha_captura, especie ) REFERENCES Ejemplar ( zona, fecha_captura, especie ) ;
...
ALTER TABLE Ejemplar ADD CONSTRAINT Ejemplar_ZonaNombreComun_FK FOREIGN KEY ( especie, zona ) REFERENCES ZonaEjemplar ( especie, zona ) ;
...
ALTER TABLE Observada ADD CONSTRAINT Observada_Ejemplar_FK FOREIGN KEY ( zona, fecha_captura, especie ) REFERENCES Ejemplar ( zona, fecha_captura, especie ) ;

ALTER TABLE ZonaEjemplar ADD CONSTRAINT ZonaNombreComun_Zona_FK FOREIGN KEY ( zona ) REFERENCES Zona ( zona ) ;
